            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="active"><a href="ohcms_insurance_add.php"><i class="icon mdi mdi-home"></i><span>Add Insurance Type</span></a>
                  </li>
                  ...
                  <li class="parent active"><a href="ohcms_bill_calculator.php"><i class="icon mdi mdi-cogs"></i><span>Bill Calculation</span></a>
                  </li>
