...
<head>
  ...
  <meta name="author" content="Team FYP">
    ...
    <div class="card-deck mb-3 text-center">
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          ...
          <a href="RegistrationDesk/employee_register.php" class="btn btn-lg btn-block btn-outline-primary">Register</a>
    ...
    <footer class="pt-4 my-md-5 pt-md-5 border-top">
      <div class="row">
        <div class="col-12 col-md">
          <small class="d-block mb-3 text-muted">&copy; All Rights Reserved HealthCare System-<?php echo date('Y'); ?>. Crafted With Love by Team FYP.</small>
        </div>
    </footer>
  </div>
</body>
